...
export default function Introduction({checkmark, onClick}) {
  return (
    <Box
      ...
      autoComplete="off"
    >
        <p>This tool is designed to aid students who must produce a thesis or dissertation under the supervision of their committee chair and successfully defend it as part of their degree requirements. It employs The University of Alabama's specific formatting guidelines to generate a template to which you insert your document's text.</p>
        <p>Copies of your Document will be placed in the UA Library Digital Repository and ProQuest (UMI/ProQuest). Because of this, your document must meet professional standards of published research. Both your committee and The Graduate School expect to see careful attention to style and format in the document you present to fulfill the requirements for your graduate degree.</p>
