...
export default function Introduction({checkmark, onClick}) {
  return (
    ...
    >
        ...
        <p>For your reference, please review the <a href='https://graduate.ua.edu/current-students/thesis-and-dissertations/' target='_blank'>Graduate College Format Manual</a> and <a href='https://graduate.ua.edu/wp-content/uploads/2022/10/Sample-ETD-Preliminary-Pages-Suggested-Layout-and-Format.pdf' target='_blank'>Sample Formatted Document</a>.</p>
