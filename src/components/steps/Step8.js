  ...
  return (
    ...
    >
      <div>
        ...
        <p>Once you have generated your document by clicking on "Create Document," save it as a Microsoft Word Document. When you open the document and attempt to edit it, you'll be asked if you'd like to update fields. Click yes.</p>
